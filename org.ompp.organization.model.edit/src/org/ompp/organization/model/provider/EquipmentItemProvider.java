...
/**
 * This is the item provider adapter for a {@link org.ompp.organization.model.Equipment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Equipment_manufacturer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Equipment_manufacturer_feature", "_UI_Equipment_type"),
				 ModelPackage.Literals.EQUIPMENT__MANUFACTURER,
				 true,
				 false,
				 false,
	...
	protected void addParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Equipment_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Equipment_parameters_feature", "_UI_Equipment_type"),
				 ModelPackage.Literals.EQUIPMENT__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
